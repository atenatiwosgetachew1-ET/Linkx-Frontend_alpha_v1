...
function Windows({ id, type, isSideBarMenuOpen, action, selectedContent, selectedSubContent, formIResponse,formIIResponse,formToolResponse,batchFilesSearchResults,searchResultsVisible,searchPlaceholder,batchFilesCollection, onClose, onMove, zIndex, onFocus }) {
                               ...
                               <div id="batch_files_dataframe_infos_right_container" className="dataframe_infos_right_container">
                                <table cellpadding='0'>
                                  <tbody>
                                    <tr>
                                      <td>Broker/API</td>
                                      <td>172.168.128.128:9092</td>
                                    </tr>
                                    <tr>
                                      <td>Storage</td>
                                      <td>172.168.111.111:9000</td>
                                    </tr>
                                    <tr>
                                      <td>Tool</td>
                                      <td>Neo4j</td>
